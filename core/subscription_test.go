...
func Test_subscription_MarshalJSON(t *testing.T) {
	...
	expected := `{"Id":"6ba7b814-9dad-11d1-0-00c04fd430c8","Kind":"salut","Resources":[{"Reference":{"ObjectId":{"test":"value"}},"SubscribedAt":"0001-01-01T00:00:00Z","SubscribedUntil":"1984-04-04T00:01:00Z"}]}`
...
func Test_MemorySubscription_New(t *testing.T) {
	...
	if subcription.Id() != "6ba7b814-9dad-11d1-3-00c04fd430c8" {
