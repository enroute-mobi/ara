...
func Test_StopAreaController_Index(t *testing.T) {
	...
	//Test Results
	expected := `[{"Id":"6ba7b814-9dad-11d1-0-00c04fd430c8","CollectedAlways":true,"CollectGeneralMessages":false,"Monitored":false,"Name":"First StopArea","CollectChildren":false}]`
