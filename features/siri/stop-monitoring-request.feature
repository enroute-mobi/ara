    ...
    """
{
  ...
  @ARA-1240
  Scenario: Handle a missing StopVisit Order in collect by using SIRI Lite Stop Monitoring should not create stopVisit
    Given a lite SIRI server waits GetStopMonitoring request on "http://localhost:8090" to respond with
    """
{
  "Siri": {
    ...
    And a StopArea exists with the following attributes:
      ...
      | ObjectIDs | "internal": "STIF:StopPoint:Q:41178:" |
    When a minute has passed
    Then a StopVisit "internal":"SNCF_ACCES_CLOUD:Item::41178_133528:LOC" should not exist
