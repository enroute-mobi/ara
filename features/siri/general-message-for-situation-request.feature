Feature: Support SIRI GeneralMessage for Situation
  ...
  Scenario: 3009 - Handle a SIRI ServiceDelivery after GM Request to a SIRI server
    Given a SIRI server waits GeneralMessageRequest request on "http://localhost:8090" to respond with
      ...
      <S:Envelope xmlns:S="http://schemas.xmlsoap.org/soap/envelope/">
          <S:Body>
              <ns8:GetGeneralMessageResponse xmlns:ns3="http://www.siri.org.uk/siri" xmlns:ns4="http://www.ifopt.org.uk/acsb" xmlns:ns5="http://www.ifopt.org.uk/ifopt" xmlns:ns6="http://datex2.eu/schema/2_0RC1/2_0" xmlns:ns7="http://scma/siri" xmlns:ns8="http://wsdl.siri.org.uk" xmlns:ns9="http://wsdl.siri.org.uk/siri">
                  <ServiceDeliveryInfo>
                      ...
                      <ns3:GeneralMessageDelivery version="2.0:FR-IDF-2.4">
                          ...
                          <ns3:GeneralMessage formatRef="FRANCE">
                              ...
                              <ns3:Content xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ns9:IDFGeneralMessageStructure">
                                  <Message>
                                      <MessageType>longMessage</MessageType>
                                      <MessageText xml:lang="NL">La nouvelle carte d'abonnement est disponible au points de vente du réseau
                                      </MessageText>
                                  </Message>
                              </ns3:Content>
                          </ns3:GeneralMessage>
                          <ns3:GeneralMessage formatRef="FRANCE">
                              ...
                              <ns3:Content xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ns9:IDFGeneralMessageStructure">
                                  <Message>
                                      <MessageType>longMessage</MessageType>
                                      <MessageText xml:lang="NL">Les nouveaux tarifs sont consultable sur le site internet</MessageText>
                                  </Message>
                              </ns3:Content>
                          </ns3:GeneralMessage>
                      </ns3:GeneralMessageDelivery>
      ...
      """
    And a Partner "ineo" exists with connectors [siri-check-status-client, siri-general-message-request-collector, siri-general-message-request-broadcaster] and the following settings:
    | remote_url           | http://localhost:8090 |
    | local_credential     | internal              |
      ...
      <S:Body>
        <ns7:GetGeneralMessage xmlns:ns2="http://www.siri.org.uk/siri" xmlns:ns3="http://www.ifopt.org.uk/acsb" xmlns:ns4="http://www.ifopt.org.uk/ifopt" xmlns:ns5="http://datex2.eu/schema/2_0RC1/2_0" xmlns:ns6="http://wsdl.siri.org.uk/siri" xmlns:ns7="http://wsdl.siri.org.uk">
          <ServiceRequestInfo>
            ...
            <ns2:RequestorRef>internal</ns2:RequestorRef>
            <ns2:MessageIdentifier>GeneralMessage:Test:0</ns2:MessageIdentifier>
          </ServiceRequestInfo>
          <Request version="2.0:FR-IDF-2.4">
            <ns2:RequestTimestamp>2017-03-29T16:49:00.311Z</ns2:RequestTimestamp>
            ...
            <Answer>
              <ns3:GeneralMessageDelivery version="2.0:FR-IDF-2.4">
                ...
                <ns3:GeneralMessage>
                  ...
                  <ns3:InfoMessageVersion>1</ns3:InfoMessageVersion>
                  <ns3:InfoChannelRef>Perturbation</ns3:InfoChannelRef>
                  <ns3:ValidUntilTime>2017-01-07T20:30:06.000+02:00</ns3:ValidUntilTime>
                  <ns3:Content xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ns9:IDFLineSectionStructure">
                    <Message>
                      <MessageType>longMessage</MessageType>
                      <MessageText>La nouvelle carte d'abonnement est disponible au points de vente du réseau</MessageText>
