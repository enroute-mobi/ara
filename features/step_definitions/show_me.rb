...
Given(/^I see ara (vehicle_journeys|stop_areas|stop_visits|lines|partners|operators)$/) do |model_type|
  show_me model_type
end

Then(/^show me ara (vehicle_journeys|stop_areas|stop_visits|lines|partners|operators)$/) do |model_type|
  show_me model_type
end
