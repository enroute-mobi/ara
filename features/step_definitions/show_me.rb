...
Then(/^show me ara (vehicle_journeys|stop_areas|stop_visits|lines|vehicles|partners|operators|scheduled_stop_visits|subscriptions)(?: for partner "([^"]+)")?$/) do |model_type, partner_name|
