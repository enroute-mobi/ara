...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.81.0-devel // indirect
	github.com/DataDog/datadog-agent/pkg/opentelemetry-mapping-go/otlp/attributes v0.81.0-devel // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/log v0.81.0-devel // indirect
