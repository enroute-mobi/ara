...
func Test_SIRILinesDiscoveryResponse_BuildXML(t *testing.T) {
	...
	annoted1 := &siri.SIRIAnnotatedLine{
		LineRef:   "NINOXE:Line:BP:1:LOC",
		LineName:  "Test 1",
		Monitored: true,
	}
	annoted2 := &siri.SIRIAnnotatedLine{
		LineRef:   "NINOXE:Line:BP:2:LOC",
		LineName:  "Test 2",
		Monitored: true,
	}
	annoted3 := &siri.SIRIAnnotatedLine{
		LineRef:   "NINOXE:Line:BP:3:LOC",
		LineName:  "Test 3",
		Monitored: true,
	}

	response.AnnotatedLines = []*siri.SIRIAnnotatedLine{annoted1, annoted2, annoted3}
