...
const estimatedTimeTablenotifyTemplate = `<ns1:NotifyEstimatedTimetable
	...
	<Notification>{{range .Deliveries}}
		<ns3:EstimatedTimetableDelivery version="2.0:FR-IDF-2.4">
			...
			<ns3:EstimatedJourneyVersionFrame>
				<ns3:RecordedAtTime>2017-01-01T12:00:00.000Z</ns3:RecordedAtTime>{{ range .EstimatedVehicleJourneys }}
		...
		</ns3:EstimatedTimetableDelivery>{{end}}
	</Notification>
	<NotifyExtension
		xmlns:ns2="http://www.ifopt.org.uk/acsb"
		xmlns:ns3="http://www.ifopt.org.uk/ifopt"
